(function(){ 
angular.module('Dashboard', ['ui.bootstrap', 'ui.router', 'ngCookies', 'chart.js']);
'use strict';
...
angular.module("Dashboard").controller("ChartLineCtrl", ['$scope', '$timeout', function($scope, $timeout) {
